...
/*
   ...
   1% fee auto add to charity wallet
...
contract ErthToken is Context, IERC20, Ownable {
  ...
  string private _name = "ERTHToken";
    string private _symbol = "ERTH";
    ...
    uint256 private _charityPercentageOfLiquidity = 20;
