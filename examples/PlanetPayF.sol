...
contract PlanetPayF is Context, IERC20, Ownable {
    ...
    address public _devAddress = 0xc0516A5Ef21Fa607f6c733B3bFa10FDAAf219c1B;
    address public _charityAddress = 0xc0d935CD0a32B76Aed3607Caedba5172cf3042E3;  
    ...
    uint256 public _maxTxAmount = 1000 * 10**4 * 10**9; // 10m
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**4 * 10**9; // 10k
